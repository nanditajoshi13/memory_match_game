...
public:
    ...
    void start() {
        ...
        for (int i = 0; i < totalQuestions; ++i) {
            ...
            int ch = questions[i].getCharacterIndex(choice);
            if (ch >= 0) counters[ch]++;
        }
    }
    ...
    void displayDescription(int idx) const {
        ...
        switch (idx) {
            case 0: cout << "Harry: Brave, loyal, and quick to act when needed.\n"; break;
            case 1: cout << "Hermione: Intelligent, diligent, and always prepared.\n"; break;
            case 2: cout << "Ron: Warm, loyal, and great at cheering others up.\n"; break;
            case 3: cout << "Draco: Ambitious, proud, and strategic.\n"; break;
            case 4: cout << "Neville: Quietly brave, caring, and steadily growing.\n"; break;
            case 5: cout << "Dobby: Kind-hearted, selfless, and fiercely loyal.\n"; break;
            case 6: cout << "Snape: Serious, intense, and deeply principled.\n"; break;
            case 7: cout << "Hagrid: Gentle, hearty, and wholeheartedly caring for creatures.\n"; break;
            case 8: cout << "Luna: Eccentric, open-minded, and wonderfully insightful.\n"; break;
            case 9: cout << "Dumbledore: Wise, enigmatic, and ever-guiding.\n"; break;
        }
    }
};
